...
/// @title TownSquare V2 ArtProxy
/// @author townsquare, @pelumi527
/// @notice Official art proxy to generate TownSquare veNFT artwork
contract VeArtProxy is IVeArtProxy {
    ...
    bytes8[5][10] palettes = [
        ...
        [bytes8("#b28bf9"), "#b882ff", "#cf3502", "#3C4150", "#A3A3A3"], //townsquare
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "background_color": "121a26", "description": "TownSquare is a decentralized lending, liquidity & RWA yield market that makes onchain money more accessible to all.", "image": "data:image/svg+xml;base64,',
